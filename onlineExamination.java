...
public class OnlineExamination {
	...
	public void startExam() {
		...
		for (int i = 0; i < questionCount; i++) {
			...
			System.out.println("1) Option 1     3)option 3");
			System.out.println("2) Option 2     4)option 4");
	...
	public static void main(String[] args) {
		...
		OnlineExamination examSystem = new OnlineExamination(uName, pWord);examSystem.login();
